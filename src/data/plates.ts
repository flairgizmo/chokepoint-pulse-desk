...
export const PLATES = {
  ...
  fiber: TOPIC('fiber.jpg', 'Optical fiber — Wikimedia Commons', 'A bundle of optical fiber catching light'),
  ...
  library: TOPIC('library.jpg', 'British Library — Wikimedia Commons', 'The British Library reading-room courtyard'),
  exchange: TOPIC('exchange.jpg', 'New York Stock Exchange — Wikimedia Commons', 'The New York Stock Exchange facade on Wall Street'),
  datacenter: TOPIC('datacenter.jpg', 'Google data center — Wikimedia Commons', 'Server aisles inside a Google data center'),
