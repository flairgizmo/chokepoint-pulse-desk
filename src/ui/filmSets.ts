...
export const FILM_SETS: Record<string, FilmSlide[]> = {
  ...
  people: [
    { id: 'verdian', title: 'VERDIAN', src: PLATES.ucl.src, stageKind: 'person', stageId: 'verdian' },
    { id: 'tasca', title: 'TASCA', src: PLATES.boston.src, stageKind: 'person', stageId: 'tasca' },
    { id: 'hargreaves', title: 'HARGREAVES', src: PLATES.geneva.src, stageKind: 'person', stageId: 'hargreaves' },
    { id: 'riley', title: 'RILEY', src: PLATES.cambridge.src, stageKind: 'person', stageId: 'riley' },
    { id: 'rawel', title: 'RAWEL', src: PLATES.canaryDay.src, stageKind: 'person', stageId: 'rawel' },
  ],
  cbdc: [
